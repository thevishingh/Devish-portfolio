...
function SectionHeader({ comment, title, action, actionLink }) {
  return (
    <div className="flex items-end justify-between mb-12">
      <div>
        <span className="font-mono text-sm text-[var(--accent-cyan)] mb-2 block">
          // {comment}
        </span>
        <h2 className="text-3xl sm:text-4xl font-bold font-mono text-[var(--text-primary)]">
          {title}
        </h2>
      ...
      {action && (
        <Link
          to={actionLink}
          className="hidden sm:flex items-center gap-1.5 font-mono text-sm text-[var(--accent-cyan)] hover:underline group"
        >
          {action}{" "}
...
function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-[1] bg-gradient-to-b from-[var(--bg-primary)]/50 via-transparent to-[var(--bg-primary)]" />
      <div className="absolute bottom-0 left-0 right-0 h-24 sm:h-32 z-[1] bg-gradient-to-t from-[var(--bg-primary)] to-transparent" />
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 lg:pt-28 pb-14 sm:pb-16 lg:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] xl:grid-cols-[1.05fr_0.95fr] gap-10 lg:gap-12 xl:gap-16 items-center">
          {/* Left Content */}
          <div className="order-1 max-w-3xl">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[var(--accent-cyan)]/5 border border-[var(--accent-cyan)]/20 mb-6 sm:mb-8"
            >
              <span className="w-2 h-2 rounded-full bg-[var(--accent-green)] animate-pulse" />
              <span className="font-mono text-[10px] sm:text-xs text-[var(--accent-cyan)]">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-[var(--text-primary)] font-mono leading-[1.05] mb-4"
            >
              {personalInfo.name}
            ...
            <motion.h2
              ...
              className="text-lg sm:text-2xl lg:text-3xl font-mono text-[var(--text-secondary)] mb-5 sm:mb-6"
            >
              {personalInfo.title}
            </motion.h2>
            ...
            >
              <p className="font-mono text-sm sm:text-base lg:text-lg text-[var(--accent-cyan)] flex items-center flex-wrap">
            ...
            <motion.p
              ...
              className="text-[var(--text-secondary)] text-sm sm:text-base leading-relaxed mb-8 sm:mb-10 max-w-xl"
            >
            ...
            >
              <Link
                to="/projects"
                className="group inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 rounded-lg bg-[var(--accent-cyan)]/10 border border-[var(--accent-cyan)]/30 text-[var(--accent-cyan)] font-mono text-sm hover:bg-[var(--accent-cyan)]/20 hover:border-[var(--accent-cyan)]/50 transition-all duration-300"
              >
                View Projects
              ...
              <Link
                to="/contact"
                className="group inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 rounded-lg bg-[var(--bg-card)] border border-[var(--border-color)] text-[var(--text-primary)] font-mono text-sm hover:border-[var(--accent-cyan)]/30 transition-all duration-300"
              >
              ...
              <a
                ...
                target="_blank"
                className="group inline-flex items-center justify-center gap-2 px-5 sm:px-6 py-3 rounded-lg text-[var(--text-secondary)]  cursor-pointer font-mono text-sm hover:text-[var(--accent-cyan)] transition-colors duration-300"
              >
            ...
            >
              {personalInfo.stats.map((stat, i) => (
                <div key={i} className="text-left">
                  <div className="font-mono text-xl sm:text-2xl font-bold text-[var(--text-primary)]">
                    {stat.value}
                  </div>
                  <div className="font-mono text-[10px] sm:text-xs text-[var(--text-secondary)] mt-1 uppercase tracking-wider">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <motion.div
            ...
            className="order-2 w-full min-w-0 flex justify-center lg:justify-end relative z-30 mt-8 lg:mt-0"
          >
            <div className="w-full min-w-0 max-w-[320px] sm:max-w-md md:max-w-lg lg:max-w-xl">
              <CodeEditorPreview />
            </div>
          </motion.div>
        </div>
      ...
      <motion.div
        ...
        className="hidden sm:flex absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex-col items-center gap-2"
      >
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {timeline.slice(0, 2).map((t) => (
                ...
                >
                  ...
                  <div>
                    <p className="font-mono text-xs text-[var(--text-primary)] font-semibold">
                      {t.title}
                    </p>
            ...
            <Link
              to="/about"
              className="mt-6 inline-flex items-center gap-1.5 font-mono text-sm text-[var(--accent-cyan)] hover:underline group sm:hidden"
            >
              Know More{" "}
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
          ...
          >
            {personalInfo.stats.map((stat, i) => (
              <div
                key={i}
                className="p-5 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)] hover:border-[var(--accent-cyan)]/20 transition-all duration-500 group"
              >
                <div className="font-mono text-2xl font-bold text-[var(--accent-cyan)] group-hover:scale-105 transition-transform origin-left duration-300">
                  {stat.value}
                </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mt-8">
          {skills
            ...
            .map((s) => (
              <span
                key={s.name}
                className="px-3 py-1.5 rounded-lg bg-[var(--bg-card)] border border-[var(--border-color)] font-mono text-xs text-[var(--text-secondary)]"
              >
                {s.name}
              </span>
            ))}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {featured.map((project, i) => (
            ...
            >
              ...
              <div className="p-5">
                <h3 className="font-mono font-bold text-base text-[var(--text-primary)] group-hover:text-[var(--accent-cyan)] transition-colors mb-1">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {project.techStack.slice(0, 3).map((t, j) => (
                    <span
                      key={j}
                      className="font-mono text-[10px] px-2 py-0.5 rounded bg-[var(--bg-primary)] text-[var(--text-secondary)] border border-[var(--border-color)]"
                    >
                      {t}
                    </span>
                  ))}
                  {project.techStack.length > 3 && (
                    <span className="font-mono text-[10px] px-2 py-0.5 rounded bg-[var(--bg-primary)] text-[var(--text-secondary)]">
                      +{project.techStack.length - 3}
                    </span>
                  )}
                </div>
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {blogs.slice(0, 2).map((blog, i) => (
            ...
            >
              ...
              <h3 className="font-mono font-bold text-base text-[var(--text-primary)] group-hover:text-[var(--accent-cyan)] transition-colors mb-2 line-clamp-2">
                {blog.title}
              </h3>
              ...
              <div className="flex items-center gap-2">
                {blog.tags.map((tag, j) => (
                  <span
                    key={j}
                    className="font-mono text-[10px] px-2 py-0.5 rounded bg-[var(--accent-cyan)]/5 text-[var(--accent-cyan)]/70 border border-[var(--accent-cyan)]/10"
                  >
                    {tag}
                  </span>
                ))}
      ...
      <div className="relative">
        ...
        <div className="flex gap-5 animate-marquee">
          {doubled.map((t, i) => (
            <div
              key={`${t.id}-${i}`}
              className="flex-shrink-0 w-[350px] p-5 rounded-xl bg-[var(--bg-card)] border border-[var(--border-color)]"
            >
              <div className="flex gap-1 mb-3">
                {[...Array(5)].map((_, j) => (
                  <Star
                    key={j}
                    className="w-3.5 h-3.5 text-[var(--accent-cyan)] fill-[var(--accent-cyan)]"
                  />
                ))}
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-[var(--accent-cyan)]/10 border border-[var(--accent-cyan)]/20 flex items-center justify-center font-mono text-xs font-bold text-[var(--accent-cyan)]">
                  {t.avatar}
                </div>
                <div>
                  <p className="font-mono text-sm text-[var(--text-primary)] font-medium">
                    {t.name}
                  </p>
                  <p className="font-mono text-xs text-[var(--text-secondary)]">
                    {t.role}
    ...
    <section className="py-20">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold font-mono text-[var(--text-primary)] mb-4">
            Let&apos;s Build Something
            <span className="text-[var(--accent-cyan)]"> Amazing</span>
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-[var(--accent-cyan)]/10 border border-[var(--accent-cyan)]/30 text-[var(--accent-cyan)] font-mono text-sm hover:bg-[var(--accent-cyan)]/20 transition-all duration-300 hover:shadow-lg hover:shadow-[var(--accent-cyan)]/10"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-[#25D366]/10 border border-[#25D366]/30 text-[#25D366] font-mono text-sm hover:bg-[#25D366]/20 transition-all duration-300"
            >
