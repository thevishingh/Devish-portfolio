      ...
      <PageHero icon={FolderOpen} badge="Portfolio" title="Projects">
        ...
        >
          ...
          <p className="text-[var(--text-secondary)] max-w-xl text-lg leading-relaxed mb-8">
            A selection of projects that reflect my journey as a frontend
            developer building responsive interfaces, real-world products, and
          ...
          <AnimatePresence mode="wait">
            {filteredProjects.map((project, i) => (
              ...
              >
                ...
                <div className="relative h-40 overflow-hidden">
                  ...
                  >
                    <a
                      ...
                      className="w-10 h-10 disabled:cursor-not-allowed rounded-full bg-[var(--accent-cyan)]/10 border border-[var(--accent-cyan)]/30 flex items-center justify-center hover:bg-[var(--accent-cyan)]/20 transition-colors"
                    >
                  ...
                  {project.featured && (
                    <div className="absolute top-3 right-3">
                      <Badge
                        variant="outline"
                        className="bg-[var(--accent-cyan)]/10 border-[var(--accent-cyan)]/30 text-[var(--accent-cyan)] font-mono text-[10px]"
                      >
                        Featured
                      </Badge>
                    </div>
                ...
                {/* Content */}
                <div className="p-5">
                  <h3 className="font-mono font-bold text-base text-[var(--text-primary)] group-hover:text-[var(--accent-cyan)] transition-colors duration-300 mb-0.5">
                    {project.title}
                  </h3>
                  <p className="font-mono text-xs text-[var(--accent-cyan)]/60 mb-2">
                    {project.subtitle}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-3">
                    ...
                    {project.techStack.length > 3 && (
                      <span className="font-mono text-[10px] px-2 py-0.5 rounded text-[var(--text-secondary)]">
                        +{project.techStack.length - 3}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-[var(--border-color)]">
                    ...
                    {/* <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-0.5 font-mono text-[10px] text-[var(--accent-cyan)] hover:underline group/link"
                    >
                      View{" "}
